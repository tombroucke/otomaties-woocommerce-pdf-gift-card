...
class GiftCardFields
{
    ...
    {
        add_action('woocommerce_before_add_to_cart_button', [$this, 'displayGiftCardFields'], 15);
        add_filter('woocommerce_add_to_cart_validation', [$this, 'validateGiftCardFields'], 10, 3);
        add_filter('woocommerce_add_cart_item_data', [$this, 'saveGiftCartFieldsToCartItemData'], 10, 3);
        add_filter('woocommerce_get_item_data', [$this, 'setGiftCardFieldsDisplay'], 10, 2);
        add_action('woocommerce_checkout_create_order_line_item', [$this, 'saveGiftCardFieldsToOrder'], 10, 4);
    }
